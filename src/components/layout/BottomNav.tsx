...
export default function BottomNav({
  ...
  return (
    <div className="fixed left-0 right-0 bottom-0 z-50 px-4 pb-4 pt-3 pointer-events-none">
      <nav
        className="
          pointer-events-auto relative mx-auto max-w-[430px] overflow-hidden
          rounded-[34px] border border-brand-300/20 bg-[#050816]/70
          backdrop-blur-2xl
          shadow-[0_0_35px_rgba(59,130,246,0.14),0_22px_70px_rgba(0,0,0,0.55),inset_0_1px_0_rgba(255,255,255,0.10)]
